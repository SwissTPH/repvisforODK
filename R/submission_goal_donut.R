#' Plots a pie plot with a whole (donut) that visualizes the relation between actually received and targeted number of submissions.
#'
...
submission_goal_donut <- function(df, daily_submission_goal){
  date_list = collection_period(df)
