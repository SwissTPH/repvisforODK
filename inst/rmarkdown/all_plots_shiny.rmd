...
exclude_wday <- params$exclude_wday
...
```{r}
if (plot_evals$donut) {
  fig <- repvisforODK::submission_goal_donut(df = df, daily_submission_goal = daily_submission_goal, date_col = date_col, exclude_wday = exclude_wday)
} else fig <- NULL
...
if (plot_evals$line_chart_cumsum) {
  fig <- repvisforODK::submissions_timeseries_lineplot(df = df, daily_submission_goal = daily_submission_goal, date_col = date_col, exclude_wday = exclude_wday, cumulative = TRUE)
} else fig <- NULL
...
if (plot_evals$line_chart_no_cumsum) {
  fig <- repvisforODK::submissions_timeseries_lineplot(df = df, daily_submission_goal = daily_submission_goal, date_col = date_col, exclude_wday = exclude_wday, cumulative = FALSE)
} else fig <- NULL
